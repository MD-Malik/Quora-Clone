...
import HomeFooter from '../HomeLeftSpace/HomeFooter';
    ...
    <div >
      ...
      >
        <MenuItem onClick={showProfile}>
          <Profile_div>
            <img src={userInfo.userimage} alt="img" style={{ width: "40px", height: '40px', borderRadius: '50%' }} />
        ...
        <hr />
        <MenuItem style={{ padding: "0px 10px", margin: '5px 0px' }}>
        ...
        <MenuItem style={{ padding: "0px 10px", margin: '5px 0px' }}>
          ...
          Drafts</MenuItem>
        <hr />
        <Logout_section style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', rowGap: '2px' }}>
          <Section_one>
            <p>Dark mode</p>
            <h6>OFF</h6>
          </Section_one>
